    ...
    override fun onInitView(binding: ViewDataBinding, view: View) {
        ...
        sdBinding.apply {
            ...
            btnSelectMoveInDate.setOnClickListener {
                replaceFragment(R.id.flMainContainer,summaryFragment,this@SelectDateFragment.javaClass.simpleName)
                Log.d("RDFragment", "onInitView RDFragment: className ${this@SelectDateFragment.javaClass.simpleName}")
            }
            ...
            calenderViewSD.setOnDateChangeListener(object :OnDateChangeListener{
                override fun onSelectedDayChange(p0: CalendarView, p1: Int, p2: Int, p3: Int) {
                    ...
                    val month = p2+1
                    val dayOfMonth = p3
                    moveInTV.text = "$dayOfMonth / $month / $year"
                }
